      ...
      <div className="relative z-10 w-full max-w-5xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block text-white p-8">
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <div>
              <h1 className="text-2xl font-bold">PMSCare</h1>
          ...
          <div className="mb-12">
            <h2 className="text-4xl font-bold mb-4 leading-tight">
              Staff <span className="text-blue-400">Management</span><br/>Portal
            </h2>
            <p className="text-blue-200 text-lg">
              Streamline hospital operations with our comprehensive staff management system.
            </p>
          </div>
        ...
        <div className="w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full py-3.5 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:ring-4 focus:ring-blue-200 transition-all duration-300 shadow-lg shadow-blue-200 hover:shadow-xl flex items-center justify-center gap-2"
              >
          ...
          <p className="text-center text-blue-300/60 text-sm mt-6">
            © 2026 PMSCare Hospital • All rights reserved
          </p>
        </div>
      </div>
    </div>
