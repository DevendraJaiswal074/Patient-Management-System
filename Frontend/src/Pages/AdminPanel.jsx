...
function AdminPanel() {
  const cards = [
    {
      title: "All Patients",
      description: "View all patients with Checked In / Checked Out status",
      path: "/admin-dashboard/all-patients",
      color: "bg-blue-600",
      hoverColor: "hover:bg-blue-700",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="w-10 fill-white">
    ...
    },
    {
      ...
      description: "View all patients who have been checked out",
