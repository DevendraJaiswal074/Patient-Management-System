      ...
      <div className="relative z-10 w-full max-w-5xl mx-4 flex rounded-3xl overflow-hidden shadow-2xl backdrop-blur-sm bg-white/5 border border-white/10">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Patient Management</p>
              </div>
            </div>

            <h2 className="text-4xl font-bold text-white leading-tight mb-4">
              Smart Patient <br /> Management System
            </h2>
            <p className="text-blue-100 text-lg">
              Handle patient entries, appointments, and visit tracking from one
              secure platform.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 bg-white p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="md:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-xl font-bold text-gray-800">PMS</span>
          </div>
                ...
                <div className="relative flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Access patient records and visits
                    </p>
                  </div>
                  <svg
